    ...
    <div class="admin-sidebar-wrapper js-scrollbar">
        <ul class="menu">
                ...
                <ul class="sub-menu">
                    <li class="menu-item">
                        <a href="{{url('admin/coupon')}}" class=" menu-link">
                            <span class="menu-label">
                                <span class="menu-name">Add Coupons </span>
                            </span>
                            <span class="menu-icon">
                                <i class="icon-placeholder   ">
                                    A
                    ...
                    <li class="menu-item">
                        <a href="{{url('admin/coupon')}}" class=" menu-link">
                            <span class="menu-label">
                                <span class="menu-name">View Coupons </span>
                            </span>
                            <span class="menu-icon">
                                <i class="icon-placeholder   ">
                                    V
            ...
            <li class="menu-item ">
                ...
                <ul class="sub-menu">
                    <li class="menu-item">
                        <a href="https://abeerjaipur.com/admin/reports/sale-report" class=" menu-link">
                            <span class="menu-label">
                    ...
                    <li class="menu-item">
                        <a href="https://abeerjaipur.com/admin/reports/customer-report" class=" menu-link">
                            <span class="menu-label">
                    ...
                    <li class="menu-item">
                        <a href="https://abeerjaipur.com/admin/reports/inventory-report" class=" menu-link">
                            <span class="menu-label">
